...
public class AdminSiteCategoryDto {
	...
	private List<AdminSiteCategoryDto> children = new ArrayList<>();
	...
	public List<AdminSiteCategoryDto> getChildren() {
		return children;
	}

	public void setChildren(List<AdminSiteCategoryDto> children) {
