...
public class CustomLogoutSuccessHandler implements LogoutSuccessHandler {
    ...
    @Autowired
    public CustomLogoutSuccessHandler(SiteHistoryService siteHistoryService) {
    ...
    public void onLogoutSuccess(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            // 히스토리 기록
            siteHistoryService.logHistory(userId, "LOGOUT", ipAddress, "로그아웃");
            
            logger.info("로그아웃 히스토리 기록 완료: userId={}, ip={}", userId, ipAddress);
            
        } catch (Exception e) {
            logger.error("로그아웃 히스토리 기록 중 오류 발생", e);
        }
