...
<input type="hidden" name="bwrite_id" value="235" />
	...
	<tr>
		...
		<td>
			<input type="text" id="bwrite_title" name="bwrite_title" class="input_form w90 required" title="제목" value="인재 POOL 등록안내"  />
		</td>
	</tr>

	<tr>
		<td colspan="2">
			<textarea id="bwrite_content" name="bwrite_content" class="textarea_form h200p required summernote" title="내용" data-table="guava_board_write" data-target="235"><p>인재 POOL 등록안내<br></p></textarea>
		</td>
	</tr>
