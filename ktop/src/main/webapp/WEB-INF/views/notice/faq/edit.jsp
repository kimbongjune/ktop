...
<div class="board_form">
	...
	<tr>
		...
		<td>
			<input type="text" id="title" name="title" class="input_form w90" title="질문" value="${faq.title}"  />
		</td>
	</tr>

	<tr>
		<td colspan="2">
			<textarea id="answer" name="answer" class="textarea_form h200p summernote" title="내용" data-table="guava_board_write" data-target="235">${faq.answer}</textarea>
		</td>
	</tr>
