...
<div class="board_form">
	...
	<tr>
		...
		<td>
			<input type="text" id="bwrite_title" name="bwrite_title" class="input_form w90 required" title="제목" value="기존게시글" autofocus />
		</td>
	</tr>
	...
	<tr>
		<td colspan="2">
			<textarea id="bwrite_content" name="bwrite_content" class="textarea_form h200p required summernote" title="내용" data-table="guava_board_write" data-target="">기존게시글 ㅇㅇ</textarea>
		</td>
	</tr>
