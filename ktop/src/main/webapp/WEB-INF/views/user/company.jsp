    ...
    <c:otherwise>
			...
			<sec:authorize access="hasRole('ROLE_PARTNER')">
				<div class="center mt30">
					...
					<div class="error_box">
						...
						<div class="txt">등록된 회사 정보가 없습니다.<span>회사 정보를 등록해주세요</span></div>
					<a href="<c:url value='/user/company/write' />"><div class="bbs_btn01">회사정보 등록</div></a>
				</div>
				</div>
			</sec:authorize>
			<sec:authorize access="!hasRole('ROLE_PARTNER')">
		...
		<sec:authorize access="isAnonymous()">
			<div class="error_box">
				...
				<a href="<c:url value='/user/login' />"><div class="bbs_btn01">로그인</div></a>
			</div>
		</sec:authorize>
    </c:otherwise>
</c:choose>
