...
<tr>
    ...
    <td colspan="3"><input type="text" id="popup_title" name="popup_title" class="input_form w90 required" title="제목" value="asd"  /></td>
</tr>
<tr>
    <th>기간</th>
    <td>
...
<tr>
    <th>크기(가로/세로)</th>
    <td>
		<input type="text" id="popup_width" name="popup_width" class="input_form numeric w50p" maxlength="4" title="가로크기" value="200" /> px 
		<input type="text" id="popup_height" name="popup_height" class="input_form numeric w50p" maxlength="4" title="세로크기" value="200" /> px 
    </td>
    <th>위치(Top/Left)</th>
    <td>
		<input type="text" id="popup_top" name="popup_top" class="input_form numeric w50p" maxlength="4" title="Top 위치" value="10" /> px 
		<input type="text" id="popup_left" name="popup_left" class="input_form numeric w50p" maxlength="4" title="Left 위치" value="10" /> px 
    </td>
</tr>
<tr>
    ...
    <td>
		<select name="popup_hideday">
						<option value="1"  selected="selected" >하루</option>
...
<tr>
    <td colspan="4">
		<textarea id="popup_content" name="popup_content" class="textarea_form h200p required summernote" title="내용" data-table="guava_popup" data-target="14"><p>aaaaa</p></textarea>
	</td>
</tr>
</tbody>
</table>
