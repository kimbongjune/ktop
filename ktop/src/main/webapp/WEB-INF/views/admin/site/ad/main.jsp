...
<tbody>
		<tr>
			...
			<td class="center"><a href="<c:url value='/admin/site/ad/edit/1' />"><div class="ab_m ab_redline">수정</div></a>&nbsp;<div class="ab_m delete_btns Fix_FormBtns" data-href="<c:url value='/admin/site/ad/del/1' />">삭제</div></td>
		</tr>
			<tr>
			<td class="center">1</td>
