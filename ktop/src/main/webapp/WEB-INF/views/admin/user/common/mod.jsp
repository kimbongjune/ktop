...
<form name="admin_user_form" method="post" action="<c:url value='/admin/user/common/mod/${user.id}' />">
...
<tr>
    ...
    <td>
		<input type="text" id="name" name="name" class="input_form required" maxlength="20" title="성명" value="${user.name}" placeholder="실명 기입" />
    ...
    <td>
		<input type="text" id="nickName" name="nickName" class="input_form" maxlength="20" title="닉네임" value="${user.nickName}" placeholder="닉네임" />
...
<tr>
	...
	<td>
		<input type="tel" id="phoneMobile" name="phoneMobile" class="input_form hpnum hypenauto" title="휴대폰번호" value="${user.phoneMobile}" minlength="12" maxlength="13" placeholder="숫자만 입력" />
	...
	<td>
		<input type="tel" id="phoneHome" name="phoneHome" class="input_form telnum hypenauto" title="전화번호" value="${user.phoneHome}" minlength="9" maxlength="13" placeholder="숫자만 입력" />
	</td>
</tr>
<tr>
    <th><label for="email">이메일</label></th>
    <td colspan="3">
		<input type="email" id="email" name="email" class="input_form" maxlength="100" title="이메일" value="${user.email}" placeholder="이메일 주소" />
...
<tr>
	<th>이메일 수신</th>
	<td>
		<input type="radio" id="emailAgree_Y" name="emailAgree" title="이메일 수신" value="true" <c:if test="${user.emailAgree}">checked</c:if> /> <label for="emailAgree_Y">수신</label>&nbsp;&nbsp;&nbsp;
		<input type="radio" id="emailAgree_N" name="emailAgree" title="이메일 수신하지 않음" value="false" <c:if test="${!user.emailAgree}">checked</c:if> /> <label for="emailAgree_N">수신하지 않음</label>
	</td>
	<th>SMS 수신</th>
	<td>
		<input type="radio" id="smsAgree_Y" name="smsAgree" title="SMS 수신" value="true" <c:if test="${user.smsAgree}">checked</c:if> /> <label for="smsAgree_Y">수신</label>&nbsp;&nbsp;&nbsp;
		<input type="radio" id="smsAgree_N" name="smsAgree" title="SMS 수신하지 않음" value="false" <c:if test="${!user.smsAgree}">checked</c:if> /> <label for="smsAgree_N">수신하지 않음</label>
	</td>
</tr>
<tr>
	<th>광고성 정보 수신</th>
	<td>
		<input type="radio" id="adAgree_Y" name="adAgree" title="광고성 정보 수신" value="true" <c:if test="${user.adAgree}">checked</c:if> /> <label for="adAgree_Y">수신</label>&nbsp;&nbsp;&nbsp;
		<input type="radio" id="adAgree_N" name="adAgree" title="광고성 정보 수신하지 않음" value="false" <c:if test="${!user.adAgree}">checked</c:if> /> <label for="adAgree_N">수신하지 않음</label>
	</td>
	<th>이용약관 동의</th>
	<td>
		<input type="radio" id="termsAgree_Y" name="termsAgree" title="이용약관 동의" value="true" <c:if test="${user.termsAgree}">checked</c:if> /> <label for="termsAgree_Y">동의</label>&nbsp;&nbsp;&nbsp;
		<input type="radio" id="termsAgree_N" name="termsAgree" title="이용약관 동의하지 않음" value="false" <c:if test="${!user.termsAgree}">checked</c:if> /> <label for="termsAgree_N">동의하지 않음</label>
	</td>
</tr>
</tbody>
</table>
...
$(document).ready(function() {
    ...
    // 기존 휴대폰번호가 있으면 체크
    const currentPhoneMobile = '${user.phoneMobile}';
