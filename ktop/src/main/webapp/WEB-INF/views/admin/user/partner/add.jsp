...
<tr>
    ...
    <td>
					<input type="text" id="user_id" name="user_id" class="input_form alnum_ required" minlength="5" maxlength="50" title="아이디" value="" />
			</td>
...
<tr>
    ...
    <td >협력사</td>
	    ...
	    <th><label for="user_level">회원타입</label></th>
    <td>	
		<select id="user_level" name="user_level">
				<option value="1"  selected="selected">심사</option>
...
<tr>
    ...
    <td><input type="text" id="user_name" name="user_name" class="input_form required" maxlength="20" title="성명" value="" /></td>
    <th><label for="user_email">이메일</label></th>
    <td><input type="email" id="user_email" name="user_email" class="input_form" maxlength="100" title="이메일" value="" /></td>
</tr>
<tr>
	<th><label for="user_hp">휴대폰번호</label></th>
	<td><input type="tel" id="user_hp" name="user_hp" class="input_form hpnum hypenauto" title="휴대폰번호" value="" minlength="12" maxlength="13" placeholder="숫자만 입력" /></td>
	<th><label for="user_tel">전화번호</label></th>
	<td><input type="tel" id="user_tel" name="user_tel" class="input_form telnum hypenauto" title="전화번호" value="" minlength="9" maxlength="13" placeholder="숫자만 입력" /></td>
</tr>
<tr>
