...
;(function($) {
	...
	$.fn.bxSlider = function(options) {
		...
		var setup = function() {
			...
			// make modification to the wrapper (.bxWrap)
			...
			if(!slider.settings.ticker) {
				...
				if(slider.settings.auto && slider.settings.controlSelector) customControlsAuto();
		...
		var appendControls = function() {
			...
			if(false) { //!slider.settings.nextSelector && !slider.settings.prevSelector) {
		 ...
		 */
		var customControlsAuto = function() {
			$(slider.settings.controlSelector).bind('click', function() {
		...
		var clickNextBind = function(e) {
			...
			//if (slider.settings.controlSelector) $(slider.settings.controlSelector).removeClass('play').addClass('stop');
			el.goToNextSlide();
			e.preventDefault();
		}
		...
		el.goToSlide = function(slideIndex, direction) {
			...
			if(slider.settings.countSelector) $(slider.settings.countSelector).text(slider.active.index+1);
