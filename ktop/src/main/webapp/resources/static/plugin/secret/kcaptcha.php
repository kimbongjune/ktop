...
class KCAPTCHA{
	...
	function __construct(){ // new PHP declaration
		...
		do{
			...
			// 오렌지커뮤니케이션 추가
			set_session('secure_text',$this->keystring);
			...
			$fontfile_height=imagesy($font)-10;
		...
		$rand9=mt_rand(330,420)/150;
		$rand10=mt_rand(330,450)/140;
		...
		// random line
		function image_Vectoradd($palette,$startx,$starty,$angle,$length,$colour){
			$angle = deg2rad($angle);
			$endx = $startx+cos($angle)*$length;
			$endy = $starty-sin($angle)*$length;
			return(imageline($palette,$startx,$starty,$endx,$endy,$colour));
		}
		image_Vectoradd($img2,mt_rand(0, $x-1),mt_rand(10, $height-15),100,1000,$foreground);
		image_Vectoradd($img2,mt_rand(0, $x-1),mt_rand(10, $height-15),100,1000,$foreground);
		image_Vectoradd($img2,mt_rand(0, $x-1),mt_rand(10, $height-15),100,1000,$foreground);
		image_Vectoradd($img2,mt_rand(0, $x-1),mt_rand(10, $height-15),300,1000,$foreground);
		image_Vectoradd($img2,mt_rand(0, $x-1),mt_rand(10, $height-15),300,1000,$foreground);
		image_Vectoradd($img2,mt_rand(0, $x-1),mt_rand(10, $height-15),300,1000,$foreground);
		image_Vectoradd($img2,mt_rand(0, $x-1),mt_rand(10, $height-15),190,1000,$foreground);
		image_Vectoradd($img2,mt_rand(0, $x-1),mt_rand(10, $height-15),190,1000,$foreground);
		image_Vectoradd($img2,mt_rand(0, $x-1),mt_rand(10, $height-15),190,1000,$foreground);
		image_Vectoradd($img2,mt_rand(0, $x-1),mt_rand(10, $height-15),350,1000,$foreground);
		image_Vectoradd($img2,mt_rand(0, $x-1),mt_rand(10, $height-15),350,1000,$foreground);
		image_Vectoradd($img2,mt_rand(0, $x-1),mt_rand(10, $height-15),350,1000,$foreground);
