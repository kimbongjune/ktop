...
class KAKAO_OAUTH {
    ...
    function __construct($client_id) {
        ...
        $this->redirect_uri  = GUAVA_SOCIAL_CALLBACK_URL.'&provider=kakao';
        $this->ss_name       = 'ss_kakao_state_token';
    ...
    function get_auth_query() {
        ...
        return $this->authorize_url.'?client_id='.$this->client_id.'&response_type=code&state='.$this->token.'&redirect_uri='.$uri;
    }
